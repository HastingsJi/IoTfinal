...
//            self.classificationText.text = classifications.joined
            self.classificationText.text = classifications.joined(separator: "\n")
            self.message = classifications.joined(separator: "\n")
        }
    }
    @IBAction func SendMsq(_ sender: UISwitch) {
        if sender.isOn{
            print("Send message ")
            print(message)
            print("to Microcontroller")
//            mqttClient.publish("rpi/msq", withString: message)
        }
        else{
            print("Send message ")
            print(message)
